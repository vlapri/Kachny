...
<Window
    ...
    ResizeMode="NoResize">
    <Grid>
        <!-- Speech Bubble - nyní trvale viditelná -->
        <Grid Name="SpeechBubble" Margin="0,0,0,120" HorizontalAlignment="Center" VerticalAlignment="Top">
            <Grid.RenderTransform>
                <TranslateTransform X="220" Y="0"/>
            </Grid.RenderTransform>
            <Path Fill="White" Stroke="Black" StrokeThickness="2">
                <Path.Data>
                    <CombinedGeometry>
                        <CombinedGeometry.Geometry1>
                            <RectangleGeometry Rect="0,0,200,80" RadiusX="20" RadiusY="20" />
                        </CombinedGeometry.Geometry1>
            ...
            <TextBlock x:Name="SpeechText" Margin="10,10,0,10" TextWrapping="Wrap" 
                       FontSize="14" Width="180" Height="60" Text="Kvák!" 
						...
						<BeginStoryboard>
							<Storyboard>
								<ColorAnimation Storyboard.TargetName="path6"
                                    Storyboard.TargetProperty="(Rectangle.Fill).Color" To="#FFFBE03B" Duration="00:00:03" AutoReverse="True" RepeatBehavior="Forever" />
							</Storyboard>
						</BeginStoryboard>
					</EventTrigger>
				</Path.Triggers>
...
# Speech bubble objects
$speechBubble = $window.FindName("SpeechBubble")
$speechText = $window.FindName("SpeechText")

# Funkce pro změnu textu v bublině
$currentPhraseIndex = 0
$showBubble = {
    # Náhodná hláška
    $randomIndex = Get-Random -Minimum 0 -Maximum $duckPhrases.Count
    $speechText.Text = $duckPhrases[$randomIndex]
}

# timer pro pohyb kachny
...
# Timer pro změnu textu v bublině každých 5 sekund
$BubbleTimer = New-Object System.Windows.Forms.Timer;
$BubbleTimer.Interval = 4000;
$BubbleTimer.add_Tick($showBubble);
$BubbleTimer.Start();

# Zobrazit první hlášku hned na začátku
& $showBubble
